...
def startup(bot):
    ...
    # Add below line
    # ---------------------------------------------
    # channel = bot.make_room(title="4* - 4.99* | qqzzy's AutoHostRotate", password="abc", size=16, beatmapID=22538, mods=["freemod"], game_mode="osu", team_type="head-to-head", scoring_type="score")
