...
class Manager:
    def __init__(self, bot, channel):
        ...
        channel.set_command("*clone", channel.common_commands.clone, "clones the channel into the current channel. e.g. *clone #mp_123456")
        ...
        channel.set_command("*add_beatmap_blacklist", channel.common_commands.add_beatmap_blacklist,"adds a beatmap ID to the blacklist.")
        channel.set_command("*del_beatmap_blacklist", channel.common_commands.del_beatmap_blacklist,"Removes a beatmap ID from the blacklist.")
        channel.set_command("*add_beatmap_whitelist", channel.common_commands.add_beatmap_whitelist,"adds a beatmap ID to the whitelist.")
        channel.set_command("*del_beatmap_whitelist", channel.common_commands.del_beatmap_whitelist,"Removes a beatmap ID from the whitelist.")
        ...
        channel.set_command("*enable_maintain_title", channel.common_commands.enable_maintain_title, "Enables maintaining title")
        channel.set_command("*disable_maintain_title", channel.common_commands.disable_maintain_title,"disables maintaining title")
